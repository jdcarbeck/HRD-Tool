...
/*
READ COMMENT
Done by copying the calculator app from: https://javapapers.com/android/how-to-build-android-calculator-app/
Inside the calculator app, the pin code to switch screen is 1201 and the button to enter is Delete
 */
public class Calculator extends AppCompatActivity {

    static final String PINCODE = "1201";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonDel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(edt1.getText().equals(PINCODE)) {
